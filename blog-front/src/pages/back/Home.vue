    ...
    export default {
        ...
        computed: {
             name() {
                 ...
                 return user.userName ? user.userName : '游客';
             }
        },
        methods: {
             ...mapGetters(['getBuser']),
...
<style scoped>
    ...
    .grid-con-4 .grid-con-icon {
        background: rgba(145, 43, 171, 0.78)
    }
    .grid-con-4 .grid-num {
        color: rgba(145, 43, 171, 0.78)
    }
    .grid-con-5 .grid-con-icon {
        background: rgb(245, 83, 113);
    }
    .grid-con-5 .grid-num {
        color: rgb(245, 83, 113);
    }
    .grid-con-6 .grid-con-icon {
        background: rgb(73, 200, 239);
    }
    .grid-con-6 .grid-num {
        color: rgb(73, 200, 239);
    }
    .user-info {
        display: flex;
        align-items: center;
