package com.hanyuebb.blog.shiro.config;

import java.util.LinkedHashMap;
import java.util.Map;

import com.hanyuebb.blog.shiro.mgt.SessionManager;
import com.hanyuebb.blog.shiro.realm.ShiroRealm;
import com.hanyuebb.blog.shiro.util.ShiroCacheManager;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/back/logout", "anon");
		...
		// 拦截的路径
		//filterChainDefinitionMap.put("/blog/**", "auth");
		filterChainDefinitionMap.put("/blog/leaveMsg","roles[2]");
		filterChainDefinitionMap.put("/user/**","roles[1]");
		filterChainDefinitionMap.put("/kind/**","roles[1]");
		//filterChainDefinitionMap.put("/ueditor/**","roles[1]");
		filterChainDefinitionMap.put("/art/**","roles[1]");

		// 配置shiro默认登录界面地址，前后端分离中登录界面跳转应由前端路由控制，后台仅返回json数据
		shiroFilterFactoryBean.setLoginUrl("/blog/unauth");
		// 登录成功后要跳转的链接
